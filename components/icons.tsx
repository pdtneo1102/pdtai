...
export const ZaloIcon: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 48 48" fill="currentColor" {...props}>
        <path d="M24,4C14.5,4,6.2,10.8,4.4,20c-0.1,0.5-0.1,1.1-0.1,1.6c0,1.1,0.2,2.1,0.5,3.1 c0.7,2.2,2,4.2,3.7,5.9c0.2,0.2,0.3,0.5,0.3,0.8c-0.2,1.7-1.4,4.4-2.2,5.6c-0.7,1-0.3,2.4,0.8,3c0.4,0.2,0.9,0.3,1.3,0.3 c2.6,0,5.9-1.1,8.1-2.3c0.4-0.2,0.9-0.2,1.3,0c1.9,0.8,4,1.2,6.1,1.2c11,0,20-9,20-20S35,4,24,4z M29.5,28h-9 c-1.1,0-2-0.9-2-2s0.9-2,2-2h9c1.1,0,2,0.9,2,2S30.6,28,29.5,28z"/>
...
export const PhoneIcon: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
       <path d="M20.01 15.38c-1.23 0-2.42-.2-3.53-.56a.977.977 0 00-1.01.24l-1.57 1.97c-2.83-1.44-5.15-3.75-6.59-6.59l1.97-1.57c.26-.26.35-.63.24-1.01a17.07 17.07 0 00-.56-3.53.995.995 0 00-1-.75h-3.5c-.55 0-1 .45-1 1C3.5 14.26 11.74 22.5 21 22.5c.55 0 1-.45 1-1v-3.5c0-.55-.45-1-1-1z" />
    </svg>
);
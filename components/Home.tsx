...
import { CloudUploadIcon, LayerComposerIcon, EditorIcon, StoryboardIcon, LockIcon } from './icons';
...
const Home: React.FC<HomeProps> = ({ onSelectApp, title, subtitle, apps }) => {
  ...
  }, [openEmptyImageEditor, addImagesToGallery, checkLicenseAccess]);
          ...
          return (
            ...
            >
              ...
              {app.previewImageUrl && (
               ...
               {!isLicenseValid && (
                  <div className="absolute top-2 right-2 z-20 text-yellow-400/80 bg-black/40 rounded-full p-1.5 backdrop-blur-sm border border-yellow-400/30">
